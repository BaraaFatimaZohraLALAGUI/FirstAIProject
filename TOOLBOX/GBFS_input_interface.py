...
import json
from GBFS import visualize_graph
...
def get_input_GBFS():
    ...
    window.title("Greedy Best-First Search Configuration")
    ...
    # Create labels and entry fields for start node, goal node, and heuristic function
    ...
    heuristic_label = tk.Label(content_frame, text="Heuristic Function:")
    heuristic_label.pack()
    heuristic_entry = tk.Entry(content_frame)
    heuristic_entry.pack(pady=5)
    ...
    def visualize_graph_wrapper():
        ...
        heuristic_function = heuristic_entry.get()
        ...
        visualize_graph(adjacency_list, start_node, goal_node, heuristic_function, window)

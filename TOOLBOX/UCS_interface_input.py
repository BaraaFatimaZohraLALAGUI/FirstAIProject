...
import json
from UCS import visualize_graph
...
def get_input_UCS():
    ...
    window.title("Uniform Cost Search Configuration")
    ...
    start_label.pack()
    start_entry = tk.Entry(content_frame, width = 50)
    start_entry.pack(pady=5)

    goal_label = tk.Label(content_frame, text="Goal Node:")
    goal_label.pack()
    goal_entry = tk.Entry(content_frame, width = 50)
